      ...
      <nav className="bg-white border-b border-gray-100 px-4 py-4">
        <div className="max-w-3xl mx-auto">
          <Link href="/" className="flex items-center gap-2 w-fit">
            ...
            <span className="text-xl font-bold text-gray-900">culi<span style={{ color: "#f97316" }}>nse</span></span>
          </Link>
        </div>
      </nav>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-md">
          {sent ? (
            <div className="text-center">
              ...
              <Link href="/login" className="text-orange-500 hover:underline text-sm">← Back to login</Link>
            </div>
          ) : (
            <>
              ...
              <p className="text-center mt-4">
                <Link href="/login" className="text-sm text-gray-400 hover:text-orange-500 transition-colors">← Back to login</Link>
              </p>
            </>
          )}
        </div>
