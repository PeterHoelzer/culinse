...
export async function GET(
  ...
  if (id.startsWith("edamam_")) {
    ...
    try {
      ...
      const recipe = {
        ...
        sourceUrl: r.url || "#",
        cuisine: Array.isArray(r.cuisineType) ? r.cuisineType[0] : null,
  ...
  try {
    ...
    const recipe = {
      ...
      prepTime: typeof data.preparationMinutes === "number" && data.preparationMinutes > 0 ? data.preparationMinutes : null,
      cookTime: typeof data.cookingMinutes === "number" && data.cookingMinutes > 0 ? data.cookingMinutes : null,
