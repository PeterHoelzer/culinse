...
export async function GET(req: Request) {
  ...
  const lang = searchParams.get("lang") === "de" ? "de" : searchParams.get("lang") === "es" ? "es" : searchParams.get("lang") === "fr" ? "fr" : searchParams.get("lang") === "it" ? "it" : searchParams.get("lang") === "pl" ? "pl" : searchParams.get("lang") === "tr" ? "tr" : searchParams.get("lang") === "nl" ? "nl" : searchParams.get("lang") === "cs" ? "cs" : "en";
  try {
